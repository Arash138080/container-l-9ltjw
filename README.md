...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-l-9ltjw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-l-9ltjw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Arash138080/container-l-9ltjw.git
cd container-l-9ltjw
```
...
```
docker attach container-l-9ltjw
```
